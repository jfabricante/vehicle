...
class Pdf_VCR extends TCPDF {
    ...
    public function Header() {
		...
		$this->Image($image_file, 258, 5, 27, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		$image_file = base_url() . 'resources/images/oracle_logo.png';
		$this->Image($image_file, 266, 10, 19, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);

		$this->SetFont('helvetica', 'B' , 17);
		$html = "Vehicle Completion Report";
		...
		$html = 'For the Month of '.$this->date;
