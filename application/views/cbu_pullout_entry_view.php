					...
					<form class="form-horizontal">
						<div class="col-lg-12">
							<div class="form-group">
								<label for="invoices" class="col-lg-2 control-label">Search CS Numbers : </label>
								<div class="col-lg-10">
									<input type="text" id="tokenfield" class="form-control input-sm" name="cs_nos" value="" />
								</div>
							</div>
							<div class="form-group">
								<label for="invoices" class="col-lg-2 control-label"></label>
								<div class="col-lg-10">
	...
	$(document).ready(function() {
		...
		$('button#btn-submit').click(function(){
			...
			$.ajax({
				...
				url: '<?php echo base_url();?>cbu/ajax_search_cbu_cs_number',
