		...
		<div class="col-md-8">
			...
			<div id="overlay" class="overlay hide">
				...
				<div class="box-header with-border">
					<h3 class="box-title">Sales Order Date Range</h3>
				</div>
				<form target="_blank" id="form_filters" class="form-horizontal" method="POST" accept-charset="utf-8" action="oc_balance_summary_report">
				    <div class="box-body">
					    <div class="row">
							<div class="col-xs-5">
