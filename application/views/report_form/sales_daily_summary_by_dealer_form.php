		...
		<div class="col-md-8">
			<div class="box box-danger">
				...
				<div class="box-header with-border">
					<h3 class="box-title">Invoice Date Range</h3>
				</div>
				<form target="_blank" id="form_filters" class="form-horizontal" method="POST" accept-charset="utf-8" action="sales_daily_summary_by_dealer_pdf">
				    <div class="box-body">
					    <div class="row">
							<div class="col-xs-5">
