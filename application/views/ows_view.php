...
<script>
    $(document).ready(function() {
        ...
        $('#insert_units').click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url();?>ows/insert_new_vehicle",
                method: 'POST',
                dataType: 'text',
                data: {},  
                success: function(){
                    window.location.href = "<?php echo base_url(); ?>ows/new_units";
                },
            });
        });
        ...
        $('#update_csr').click(function(){
            ...
            $('#overlay').addClass('overlay');
            $.ajax({
                url: "<?php echo base_url();?>ows/updateCSR",
                method: 'POST',
                dataType: 'text',
                data: {},  
                success: function(){
                    window.location.href = "<?php echo base_url(); ?>ows/csr";
                },
            });
        });
        ...
        $('#update_invoice').click(function(){
            ...
            $('#overlay').addClass('overlay');
            $.ajax({
                url: "<?php echo base_url();?>ows/updateInvoice",
                method: 'POST',
                dataType: 'text',
                data: {},  
                success: function(){
                    window.location.href = "<?php echo base_url(); ?>ows/invoice";
                },
            });
        });
        ...
        $('#update_so').click(function(){
            ...
            $('#overlay').addClass('overlay');
            $.ajax({
                url: "<?php echo base_url();?>ows/updateSO",
                method: 'POST',
                dataType: 'text',
                data: {},  
                success: function(){
                    window.location.href = "<?php echo base_url(); ?>ows/so";
                },
            });
        });
        ...
        $('#update_pullout').click(function(){
            ...
            $('#overlay').addClass('overlay');
            $.ajax({
                url: "<?php echo base_url();?>ows/updatePullout",
                method: 'POST',
                dataType: 'text',
                data: {},  
                success: function(){
                    window.location.href = "<?php echo base_url(); ?>ows/pullout";
                },
            });
        });
