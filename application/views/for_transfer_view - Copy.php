			...
			<div class="box box-danger">
				...
				<div class="row">
					...
					<div class="col-sm-12 text-right" style="padding-right: 27px;">
						<button id="btn-submit" type="button" class="btn btn-danger">Transfer Selected</button>
					</div>
				</div>
				<div class="box-body">
...
-->
							...
							?>
								<tr>
									<td class="text-left"><input class="cb_cs_number" type="checkbox" value="<?php echo $row->CS_NUMBER; ?>" name="transfer[]"></td>
...
$(document).ready(function() {
	...
	$( "#btn-submit" ).click(function() {
		...
		if(count > 0){
			swal({
				title:  count + ' unit(s)',
				text: 'Successfully marked as "For Inter-Org Transfer".', 
				type: "success",
