		...
		<div class="col-md-12">
			<div class="box box-danger">
				<div class="box-header with-border">
					<h3 class="box-title">Isuzu Vehicle Sales (STG)</h3>
				</div>
<!-- 				<div class="form-group" style="margin-left: 10px; margin-top: 10px; margin-bottom: 50px;">
			        <a href="<?php echo base_url();?>unpulledout/report" class="btn btn-danger pull-left" type="button" style="margin-left: 10px;"><i class="fa fa-download"> Generate Report</i></a>
			    </div> -->
				<div class="box-body">
					<table class="table table-condensed table-striped table-bordered" id="dr-list" class="display" cellspacing="0" width="100%" style="font-size: 90%;">
						...
						?>
							<tr>
								...
								<td><?php echo date1($row->TRX_DATE); ?></td>
							</tr>
							</tr>
						<?php 
						$count++;
